...
void ClapTrap::attack(const std::string& target, int damage)
{
    if (_health == 0)
    {
    ...
    {
        std::cout << "ClapTrap is out of stamina." << std::endl;
        return;
    }
    else
    {
        std::cout << _ClapTrap_name << " attack. " << target << " lose " << damage << " hp !" << std::endl;
        _stamina--;
